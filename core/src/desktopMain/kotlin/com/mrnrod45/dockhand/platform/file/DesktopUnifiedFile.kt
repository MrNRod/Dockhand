...
class DesktopUnifiedFile(private val file: File) : UnifiedFile {
    ...
    override val size: Long
        get() = if (isDirectory) {
            // Logic for directory size if needed, or recursive check
            // For now, mirroring simple behavior
    ...
    override fun listFiles(): List<UnifiedFile> {
        ...
        return files.map { DesktopUnifiedFile(it) }
    }
