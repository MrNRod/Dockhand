...
import com.mrnrod45.dockhand.DockhandApplication
...
class AndroidUsbController(
    ...
    companion object {
        private const val ACTION_USB_PERMISSION = "com.mrnrod45.dockhand.USB_PERMISSION"
        ...
        fun requestPermissionIfNeeded(usbManager: UsbManager, device: android.hardware.usb.UsbDevice) {
            ...
            val context = DockhandApplication.context
