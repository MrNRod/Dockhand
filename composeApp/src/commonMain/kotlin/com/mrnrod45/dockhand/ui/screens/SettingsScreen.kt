        ...
        Column(
            ...
            if (platformType == PlatformType.DESKTOP) {
                SettingsDropdown(
                    ...
                    selectedValue = when(themeConfig.mode) {
                        com.mrnrod45.dockhand.ui.theme.ThemeMode.SYSTEM -> "Follow System"
                        com.mrnrod45.dockhand.ui.theme.ThemeMode.LIGHT -> "Light"
                        com.mrnrod45.dockhand.ui.theme.ThemeMode.DARK -> "Dark"
                    },
                    items = listOf(
                        "Follow System" to com.mrnrod45.dockhand.ui.theme.ThemeMode.SYSTEM,
                        "Light" to com.mrnrod45.dockhand.ui.theme.ThemeMode.LIGHT,
                        "Dark" to com.mrnrod45.dockhand.ui.theme.ThemeMode.DARK
                    ),
            ...
            if (platformType == PlatformType.ANDROID) {
                ...
                data class ThemePreset(
                    val label: String,
                    val mode: com.mrnrod45.dockhand.ui.theme.ThemeMode,
                    val darkConfig: com.mrnrod45.dockhand.ui.theme.DarkThemeConfig,
                    val dynamic: Boolean
                )
                
                val presets = listOf(
                    ThemePreset("Light", com.mrnrod45.dockhand.ui.theme.ThemeMode.LIGHT, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.STANDARD, false),
                    ThemePreset("Dark", com.mrnrod45.dockhand.ui.theme.ThemeMode.DARK, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.STANDARD, false),
                    ThemePreset("Black", com.mrnrod45.dockhand.ui.theme.ThemeMode.DARK, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.AMOLED, false),
                    ThemePreset("System", com.mrnrod45.dockhand.ui.theme.ThemeMode.SYSTEM, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.STANDARD, false),
                    ThemePreset("System Black", com.mrnrod45.dockhand.ui.theme.ThemeMode.SYSTEM, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.AMOLED, false),
                    ThemePreset("System Dynamic", com.mrnrod45.dockhand.ui.theme.ThemeMode.SYSTEM, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.STANDARD, true),
                    ThemePreset("Light Dynamic", com.mrnrod45.dockhand.ui.theme.ThemeMode.LIGHT, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.STANDARD, true),
                    ThemePreset("Dark with Dynamic", com.mrnrod45.dockhand.ui.theme.ThemeMode.DARK, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.STANDARD, true),
                    ThemePreset("Black with Dynamic", com.mrnrod45.dockhand.ui.theme.ThemeMode.DARK, com.mrnrod45.dockhand.ui.theme.DarkThemeConfig.AMOLED, true)
                )
