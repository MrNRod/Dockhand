...
// This theme now serves Windows/Linux only — macOS ships as a separate native
// SwiftUI app (see /macosApp) which gets real system materials/typography for free.
...
actual fun AppTheme(
    ...
    val baseColorScheme = if (effectiveDarkTheme) DarkColorScheme else LightColorScheme
