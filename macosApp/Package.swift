...
// `:core:linkReleaseFrameworkMacosArm64` (packaging, via NSTK_FRAMEWORK_DIR — see
...
let frameworkDirName = ProcessInfo.processInfo.environment["NSTK_FRAMEWORK_DIR"] ?? "debugFramework"
